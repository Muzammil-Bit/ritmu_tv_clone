...
import 'package:ritmu_tv_clone/vimeo_player/vide_config.dart';
...
class _VimeoVideoPlayerState extends State<VimeoVideoPlayer> {
  ...
  void _videoPlayer() {
    ...
    _getVimeoVideoConfigFromUrl(widget.vimeoPlayerModel.url).then((value) async {
      ...
      print("FINAL URL :: ${vimeoMp4Video}");

      _videoPlayerController = VideoPlayerController.network(vimeoMp4Video, videoPlayerOptions: VideoPlayerOptions(mixWithOthers: true));
